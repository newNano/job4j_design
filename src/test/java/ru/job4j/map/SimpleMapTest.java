...
class SimpleMapTest {
    ...
    @Test
    void checkWhenKeyIsNull() {
        Integer k = null;
        String v = "qwerty";
        assertThat(map.put(k, v)).isTrue();
        assertThat(map.put(k, "test")).isFalse();
        assertThat(map.get(null)).isEqualTo("qwerty");
    }
